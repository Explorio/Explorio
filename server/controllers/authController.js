...
module.exports = {
  ...
  addLocation: async (req, res, next) => {
    ...
    const sqlQuery = 'INSERT INTO countries (location, lat, long, visitedCountries, destinationCountries, userId) VALUES ($1, $2, $3, $4, $5, $6);'
    const params = [location, lat, long, visitedCountries, destinationCountries, userId];
    ...
    try {
      ...
      for (let i = 0; i < allLocations.length; i++) {
        if (allLocations[i].visitedcountries === true) obj.placesVisitedArray.push(allLocations[i])
